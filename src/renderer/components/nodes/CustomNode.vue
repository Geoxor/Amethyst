...
<template>
  <div
    class="duration-user-defined flex select-none h-full text-text-title gap-2 relative rounded-4px hover:border-primary-800 border-1 border-surface-500 flex gap-2 bg-surface-800  p-2"
