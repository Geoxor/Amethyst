...
onMounted(() => {
  ...
  const render = () => {
    ...
    const spectrum = new Float32Array(props.analyser.frequencyBinCount);
    props.analyser.getFloatFrequencyData(spectrum);
    material.uniforms.u_amplitudes.value = spectrum;
