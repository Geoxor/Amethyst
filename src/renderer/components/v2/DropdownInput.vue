...
<template>
  <button
    class="flex min-w-32 justify-between relative cursor-pointer gap-1 items-center bg-surface-600 text-accent py-1 px-4 text-13px font-weight-user-defined rounded-8px gap-2"
