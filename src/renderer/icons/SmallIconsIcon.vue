<template>
  ...
  >
    ...
    />
    <path
      d="M13 7H11C10.448 7 10 6.552 10 6V4C10 3.448 10.448 3 11 3H13C13.552 3 14 3.448 14 4V6C14 6.552 13.552 7 13 7Z"
      fill="currentColor"
    />
    <path
      opacity="0.65"
    ...
    />
    <path
      d="M20 14H18C17.448 14 17 13.552 17 13V11C17 10.448 17.448 10 18 10H20C20.552 10 21 10.448 21 11V13C21 13.552 20.552 14 20 14Z"
      fill="currentColor"
    />
    <path
      opacity="0.65"
    ...
    />
    <path
      d="M13 21H11C10.448 21 10 20.552 10 20V18C10 17.448 10.448 17 11 17H13C13.552 17 14 17.448 14 18V20C14 20.552 13.552 21 13 21Z"
      fill="currentColor"
    />
    <path
      opacity="0.65"
