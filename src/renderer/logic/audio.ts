...
export class AmethystAudioNode {
  ...
  public component: DefineComponent<object, object, any>;

  public constructor(public pre: GainNode, public post: GainNode, name: string, component: DefineComponent<object, object, any>, position: NodeProperties["position"], public isRemovable: boolean = true, public isBypassable: boolean = true, public isResettable: boolean = true) {
    const id = uuidv4();
