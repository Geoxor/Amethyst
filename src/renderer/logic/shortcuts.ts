...
export class Shortcuts {
  ...
  public DEFAULT_BINDINGS: ShortcutBindings = {
    ...
    "appearance.toggle.playback_controls": [["F10"], () => amethyst.state.settings.value.appearance.showPlaybackControls = !amethyst.state.settings.value.appearance.showPlaybackControls],
    "appearance.toggle.debug_statistics": [["F9"], () => amethyst.state.settings.value.appearance.showDebugStats = !amethyst.state.settings.value.appearance.showDebugStats],
