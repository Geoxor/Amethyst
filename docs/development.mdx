...
<Warning>
  Make sure you're using node.js v20.19.1 as any other version is unsupported and may cause unforeseen issues or unintended behaviour
</Warning>
...
If you use nvm you can install Node.js v20.19.1 with the following commands:
...
After installing Node.js v20.19.1 please install yarn through npm:
