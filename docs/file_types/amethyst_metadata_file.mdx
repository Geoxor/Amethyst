...
Upon loading metadata of a file, Amethyst will create a `.amf` similar to  [Ableton Anaylsis Files (.asd)](https://www.ableton.com/en/manual/managing-files-and-sets/#5.1.2%20Analysis%20Files%20(.asd)) to store it's information for faster future access 
